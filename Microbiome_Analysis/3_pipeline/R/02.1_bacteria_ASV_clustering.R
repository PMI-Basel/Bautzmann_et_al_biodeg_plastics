...
source <- paths[1,1]
taxa_database <- paths[2,1] #bacteria db
...
for (run in runs) {
  ...
  sample.names <- sapply(strsplit(basename(fnFs), "_", fixed=T), `[`, 1)
...
if(output){
  ...
  dir.create("../../4_output/bacteria_ASV/quality_check")
  
  path_out <- c("../../4_output/bacteria_ASV/")
  path_out_qc <- c("../../4_output/bacteria_ASV/quality_check/")
  
  #quality profiles unfiltered and untrimmed
  pdf(paste(path_out_qc,"bacteria_reads_quality_unfilt_untrim.pdf",sep=""))
  ...
  pdf(paste(path_out_qc,"bacteria_reads_quality_filt_trim.pdf",sep=""))
  for (i in 1:length(sample.names)) {
  ...
  pdf(paste(path_out_qc,"bacteria_error_rate.pdf",sep=""))
  ...
  #rarefaction plots
  pdf(paste(path_out_qc,"bacteria_rarefaction.pdf",sep=""))
  for (run in runs) {
  ...
  #number of reads
  write.xlsx(track, paste(path_out_qc, "bacteria_track.xlsx", sep=""))
  ...
  write.table(OTU_seqtab.nochim97, paste0(path_out, "ASV97/bacteria_DAT97.tab"), sep="\t")
  write.table(OTU_taxa97, paste0(path_out, "ASV97/bacteria_TAXA97.tab"), sep="\t")
  write.table(OTU_ASV_seq97, paste0(path_out, "ASV97/bacteria_SEQ97.tab"), sep="\t", row.names = F)
  invisible(dataframe2fas(OTU_ASV_seq97, paste0(path_out, "ASV97/bacteria_SEQ97.fasta")))
  write.table(OTU_ASV97, paste0(path_out, "ASV97/bacteria_ABU97.tab"), sep="\t", row.names = F)
  
  #98
  dir.create(paste0(path_out,"ASV98"))
  write.table(OTU_seqtab.nochim98, paste0(path_out, "ASV98/bacteria_DAT98.tab"), sep="\t")
  write.table(OTU_taxa98, paste0(path_out, "ASV98/bacteria_TAXA98.tab"), sep="\t")
  write.table(OTU_ASV_seq98, paste0(path_out, "ASV98/bacteria_SEQ98.tab"), sep="\t", row.names = F)
  invisible(dataframe2fas(OTU_ASV_seq98, paste0(path_out, "ASV98/bacteria_SEQ98.fasta")))
  write.table(OTU_ASV98, paste0(path_out, "ASV98/bacteria_ABU98.tab"), sep="\t", row.names = F)
  
  #99
  dir.create(paste0(path_out,"ASV99"))
  write.table(OTU_seqtab.nochim99, paste0(path_out, "ASV99/bacteria_DAT99.tab"), sep="\t")
  write.table(OTU_taxa99, paste0(path_out, "ASV99/bacteria_TAXA99.tab"), sep="\t")
  write.table(OTU_ASV_seq99, paste0(path_out, "ASV99/bacteria_SEQ99.tab"), sep="\t", row.names = F)
  invisible(dataframe2fas(OTU_ASV_seq99, paste0(path_out, "ASV99/bacteria_SEQ99.fasta")))
  write.table(OTU_ASV99, paste0(path_out, "ASV99/bacteria_ABU99.tab"), sep="\t", row.names = F)
  
  #100
  dir.create(paste0(path_out,"ASV100"))
  write.table(seqtab.nochim, paste0(path_out, "ASV100/bacteria_DAT100.tab"), sep="\t")
  write.table(taxa, paste0(path_out, "ASV100/bacteria_TAXA100.tab"), sep="\t")
  #write.table(taxa_conf, paste0(path_out, "ASV100/bacteria_TAXA100_conf.tab"), sep="\t")
  write.table(ASV_seq, paste0(path_out, "ASV100/bacteria_SEQ100.tab"), sep="\t")
  invisible(dataframe2fas(ASV_seq, paste0(path_out, "ASV100/bacteria_SEQ100.fasta")))
